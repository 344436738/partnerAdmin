...
function queryParams(params) {
	return {
		...
		$query.columnName:$("#$query.columnName").val()
		#if(!$foreach.last) 
		,
		#end
		#end
...
function del() {
	...
	//不显示遮罩
			...
			$.post("${lowerName}/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/${lowerName}/getId.do");
	$.post("${lowerName}/getId.do",{id:id},function(result){
		if(result.success){
