...
function del() {
	...
	//不显示遮罩
			...
			$.post("stSupplier/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/stSupplier/getId.do");
	$.post("stSupplier/getId.do",{id:id},function(result){
		if(result.success){
