$(function() {
	...
	$('#table').bootstrapTable( {
		...
		url : 'weixinExpandconfig/dataList.do',
		idField : "id",
...
function del() {
	...
	//不显示遮罩
			...
			$.post("weixinExpandconfig/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/weixinExpandconfig/getId.do");
	$.post("weixinExpandconfig/getId.do",{id:id},function(result){
		if(result.success){
