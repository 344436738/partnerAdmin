	...
	$('#personUserTable').bootstrapTable( {
		...
		columns : [{
		    ...
		    visible:false
			    ...
			    field : "resumeAdoptNumber",
			    title : "上传通过简历",
			    align : 'center',
			    sortable : true
		    },{
			    field : "exchangeIntegral",
			    title : "兑换积分",
			    align : 'center',
			    sortable : true,
		    },{
			    ...
			    formatter : function(value, row, index){
			    	...
			    	return "<a href='resumeManage.do?id="+row.id+"' >上传简历明细</a>";
				}
...
function userSearch(){
	$("#personUserTable").bootstrapTable("refresh");
}

function enableOrDisable(){
	var array=$("#personUserTable").bootstrapTable("getSelections");
