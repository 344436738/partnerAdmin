$(function() {
	...
	$('#table').bootstrapTable( {
		...
		url : 'weixinHdrecord/dataList.do',
		idField : "id",
...
function del() {
	...
	//不显示遮罩
			...
			$.post("weixinHdrecord/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/weixinHdrecord/getId.do");
	$.post("weixinHdrecord/getId.do",{id:id},function(result){
		if(result.success){
