$(function() {
	...
	$('#table').bootstrapTable( {
		...
		url : 'weixinPrizerecord/dataList.do',
		idField : "id",
...
function del() {
	...
	//不显示遮罩
			...
			$.post("weixinPrizerecord/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/weixinPrizerecord/getId.do");
	$.post("weixinPrizerecord/getId.do",{id:id},function(result){
		if(result.success){
