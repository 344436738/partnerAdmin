$(function() {
	...
	$('#table').bootstrapTable( {
		...
		url : 'weixinTexttemplate/dataList.do',
		idField : "id",
...
function del() {
	...
	//不显示遮罩
			...
			$.post("weixinTexttemplate/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/weixinTexttemplate/getId.do");
	$.post("weixinTexttemplate/getId.do",{id:id},function(result){
		if(result.success){
