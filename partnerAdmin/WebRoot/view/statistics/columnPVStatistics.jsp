...
<html>
  <head>
<script type="text/javascript" src="<%=request.getContextPath() %>/js/ux/statistics/columnPVStatistics.js"></script>
 ...
 //饼图  	 
	$(function(){
		var data2 = [
		     		...
		     		{name : '${column.columnName}',value : '${column.view}',color:'#'+('00000'+(Math.random()*0x1000000<<0).toString(16)).slice(-6)}<c:if test="${!stat.last}">,</c:if>
		     		</c:forEach>
		    	];
