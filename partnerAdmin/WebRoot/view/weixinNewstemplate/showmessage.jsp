...
<meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1, maximum-scale=1">
	<link type="text/css" rel="stylesheet" href="<%=path %>/css/weixin/index.css" />
	<link type="text/css" rel="stylesheet" href="<%=path %>/css/weixin/accordion.css" />
	<script src="<%=path %>/js/jquery-1.9.1.js"></script>
   	 <!--layer-->
   	 <link rel="stylesheet" type="text/css" href="<%=path %>/css/bootstraptable/layer.css">
	<link rel="stylesheet" type="text/css" href="<%=path %>/css/bootstraptable/laycode.css">
