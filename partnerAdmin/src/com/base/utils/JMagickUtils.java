...
public class JMagickUtils {
	...
	private final static String YIYA_LOGO_BG = PathUtil.getRootPath()
			+ "/static/common/images/watermark_bg.png"; // 水印背景图片 白色半透明
	private final static String YIYA_LOGO_LOGO = PathUtil.getRootPath()
	...
	public static void main(String[] args) throws MagickException {
		...
		try {
			...
			// 获取盗链图片
			JMagickUtils.Utils.ofUrl(url, "http://www.9441.com/").to(
					"D:\\t2\\1.jpg").create();
