...
public class SpringTest {
	...
	SiteMainService<SiteMain> siteMainService = (SiteMainService) context
			.getBean("siteMainService");
	// UserMainService<UserMain> userMainService =
	// (UserMainService)context.getBean("userMainService");
	SiteTypeService<SiteType> siteTypeService = (SiteTypeService) context
			.getBean("siteTypeService");
	SiteColumnService<SiteColumn> siteColumnService = (SiteColumnService) context
			.getBean("siteColumnService");
	private SysMenuService<SysMenu> sysMenuService = (SysMenuService) context
	...
	public void testList() {
		...
		System.out.println("rootMenus:" + rootMenus.size() + " childMenus:"
				+ childMenus.size() + " newMenus:" + newMenus.size());
	...
	public void addColumn() throws Exception {
		...
		bean
				.setPic("http://img1.moko.cc/users/0/9/2805/post/a2/img1_cover_6971997.jpg");
		...
		bean
				.setPic("http://img1.moko.cc/users/14/4322/1296697/post/31/img1_mokoshow_6973444.jpg");
		siteColumnService.add(bean);
	}
	...
	public void updateSite() throws Exception {
		...
		bean.setState(1);
		bean
				.setPic("http://image.mn606.com/images/2012/12/12/150_150/2012121220405491043.jpg");
