...
<link href="css/ggl/ggl.css" rel="stylesheet" type="text/css"/>
<link href="css/zp/activity-style.css" rel="stylesheet" type="text/css">
<script src="http://libs.baidu.com/jquery/2.0.0/jquery.min.js" type="text/javascript"></script>
<script type="text/javascript" src="js/wScratchPad.js"></script>
<script type="text/javascript">
	$(document).ready(function(){
	
	    var picPath = "images/ggl/nothing.png";
	    var prize = "${prize}";
	    if(prize=='1'){
	    	 picPath = "images/ggl/one.png";
	    }else if(prize=='2'){
	    	 picPath = " images/ggl/two.png";
	    }else if(prize=='3'){
	    	 picPath = " images/ggl/three.png";
	    }else{
	    	picPath = " images/ggl/nothing.png";
	    }
	    var isfirst = 0;
	    var iscontinue = 0 ;
...
<body>
	...
	<div id="card" class="c100">
		<img src=" images/ggl/card.png" width="100%" height="100%"/>
		<div id="gj">
...
<input class="pxbtn" id="save-btn" name="提 交" type="button" value="提 交">
	...
	<div class="int">
	<div class="tit"><img src=" images/ggl/1.png" width="100%"/></div>
	<ul> 
	...
	<div class="int">
	<div class="tit"><img src=" images/ggl/2.png" width="100%"/></div>
