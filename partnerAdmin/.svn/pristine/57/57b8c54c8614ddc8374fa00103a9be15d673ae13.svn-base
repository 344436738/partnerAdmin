$(function() {
	...
	$('#table').bootstrapTable( {
		...
		url : 'weixinAutoresponse/dataList.do',
		idField : "id",
...
function del() {
	...
	//不显示遮罩
			...
			$.post("weixinAutoresponse/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/weixinAutoresponse/getId.do");
	$.post("weixinAutoresponse/getId.do",{id:id},function(result){
		if(result.success){
