 ...
 <body>
	...
	<div>
			...
			<jsp:include page="../common/partnerLeft.jsp"/>
				...
				<div style="font-size:16px;color:#333;float: left;margin-left: 20px;border-bottom: 1px solid #ccc;margin-bottom: 20px;">单个简历上传积分设置</div>
				<div style=" width: 70%; float: left;">
					<form action="${msUrl}/admin/saveUploadScoreRule.do" method="post"
						...
						<input id="dkey" name="dkey" type="hidden" value="简历上传获取积分" class="gldint texwd160">
						  <p class="manage_unit clearfix mtb15">
							<label class="control-label" style="margin-left: 20px;margin-bottom: 20px;">单个简历上传审核通过获取积分:</label>
