...
<html>
  <head>
	...
	<script type="text/javascript" src="${basePath}static/common/js/baseTips.js"></script>
...
<script type="text/javascript">
	function toAdd(){
		...
		base.show(_url,'新增分类',450,250);
	}
	
	function toEdit(id){
		var _url = '${basePath}sys/$!{lowerName}/toedit.do?id='+id;
		base.show(_url,'编辑分类信息',450,250);
	}
	...
	function deletes(){
		...
		base.submit(theform,function callback(data){
