...
public class PathUtil {
	...
	public static String uploadPicPath(String fileName, String sizeDir) {
		...
		path.append(DateUtil.convertDateToYear(now)).append(File.separatorChar); // 年
																					// 2012
		path.append(DateUtil.convertDateToMonth(now))
				.append(File.separatorChar); // 月 06
		path.append(DateUtil.convertDateToDay(now)).append(File.separatorChar); // 日
																				// 17
