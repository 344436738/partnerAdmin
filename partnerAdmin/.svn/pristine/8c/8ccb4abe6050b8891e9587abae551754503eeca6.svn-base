$(function() {
	...
	$('#table').bootstrapTable( {
		...
		url : 'stProjectLeaveRecord/dataList.do',
		idField : "id",
...
function del() {
	...
	//不显示遮罩
			...
			$.post("stProjectLeaveRecord/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/stProjectLeaveRecord/getId.do");
	$.post("stProjectLeaveRecord/getId.do",{id:id},function(result){
		if(result.success){
