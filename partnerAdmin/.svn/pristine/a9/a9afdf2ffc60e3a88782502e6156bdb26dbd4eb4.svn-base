...
function del() {
	...
	//不显示遮罩
			...
			$.post("testcreate/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/testcreate/getId.do");
	$.post("testcreate/getId.do",{id:id},function(result){
		if(result.success){
