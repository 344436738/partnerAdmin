$(function() {
	...
	$('#table').bootstrapTable( {
		...
		url : 'stUserCostRecord/dataList.do',
		idField : "id",
...
function del() {
	...
	//不显示遮罩
			...
			$.post("stUserCostRecord/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/stUserCostRecord/getId.do");
	$.post("stUserCostRecord/getId.do",{id:id},function(result){
		if(result.success){
