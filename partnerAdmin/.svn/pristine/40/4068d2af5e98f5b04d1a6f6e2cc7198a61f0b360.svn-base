$(function() {
	...
	$('#table').bootstrapTable( {
		...
		url : 'stProjectSabotageRecord/dataList.do',
		idField : "id",
...
function del() {
	...
	//不显示遮罩
			...
			$.post("stProjectSabotageRecord/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/stProjectSabotageRecord/getId.do");
	$.post("stProjectSabotageRecord/getId.do",{id:id},function(result){
		if(result.success){
