...
function queryParams(params) {
	return {
		...
		recordMounth:$("#recordMounthSearch").val()
					//自定义查询属性
	};
}
//删除
function del() {
	...
	//不显示遮罩
			...
			$.post("stApportion/delete.do", data, function(result) {
...
function loadData(id) {
	...
	//loadPage("${msUrl}/stApportion/getId.do");
	$.post("stApportion/getId.do",{id:id},function(result){
		if(result.success){
