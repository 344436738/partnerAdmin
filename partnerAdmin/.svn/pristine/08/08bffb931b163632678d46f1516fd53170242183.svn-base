...
<script type="text/javascript" src="${msUrl}/js/adminCenter/downloadresumeUploadScore.js"></script>
<jsp:include page="../common/header.jsp" />
 <body>
	...
	<div>
				...
				<div style="font-size:16px;color:#333;float: left;margin-left: 20px;border-bottom: 1px solid #ccc;margin-bottom: 20px;">单个简历下载积分设置</div>
		...
		<form action="${msUrl}/admin/saveUploadScore.do" method="post"
			...
			<input id="dkey" name="dkey" type="hidden" value="简历下载扣取积分" class="gldint texwd160">
			  <p class="manage_unit clearfix mtb15">
				<label class="control-label" style="margin-left: 20px;margin-bottom: 20px;">单个简历下载获取积分:</label>
