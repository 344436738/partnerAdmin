...
import com.sun.star.sdb.InteractionHandler;
...
public final class SessionUtils {
	...
	private static final String SESSION_VIEW_DATA = "session_view_data";
	 ...
	 * @param user
	 */
	public static void setAuthViewData(HttpServletRequest request, Integer viewData) {
		request.getSession(true).setAttribute(SESSION_VIEW_DATA, viewData);
	}
	/**
	 * 从session中获取用户信息
	 * 
	 ...
	 * @return SysUser
	 */
	public static Integer getAuthViewData(HttpServletRequest request) {
		return (Integer) request.getSession(true).getAttribute(SESSION_VIEW_DATA);
	}
	 ...
	 * @return SysUser
	 */
	public static Integer getWebUserId(HttpServletRequest request) {
		return new Integer(1);
//		StWebUser user = getWebUser(request);
//		if (user != null) {
//			return user.getId();
//		}
//		return null;
